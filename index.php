<?php
$conn=new PDO('mysql:host=localhost; dbname=download_1', 'download_1', '@logis624@') or die(mysql_error());
...
<html>
<head>
<title>Upload and Download Files By Muzakie :D</title>
...
<body>
		...
		<h2>Dilarang Mengupload SC Web Phising 2 Send Mail</h2> 
		<h3> By Muzakie :D </h3>	
		<br />
		<br />
